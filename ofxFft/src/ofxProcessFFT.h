...
public:
    ...
    void drawHistoryGraph(ofPoint pt, fftRangeType drawType,int threshold = 25);
...
private:
    ...
    void drawAvgGraphUnScaled(ofPoint pt, vector<float> values, ofColor _color,int threshold = 0);
